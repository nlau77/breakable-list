...
red_pepper_flake=Ingredient.create(name:"pepper flakes")
...
provolone=Ingredient.create(name:"provolone cheese")
...
beef_and_brocolli = Recipe.create(name: "Beef and Broccoli", owner: user1)
  ...
  Instruction.create(step:"Bring water to a boil and blanch broccoli for two minutes. Set Aside.", recipe:beef_and_brocolli )
  ...
  Instruction.create(step:"Add garlic and brown for 1-2 more minutes ", recipe:beef_and_brocolli )
  Instruction.create(step:"Add broccoli, oystersauce, soy sauce", recipe:beef_and_brocolli )
  Instruction.create(step:"Mix cornstarch with a table spoon of water and add it to the pan", recipe:beef_and_brocolli )
...
curry_chicken=Recipe.create(name: "Curry Chicken", owner: user1)
  ...
  Instruction.create(step:"Mix in potatoes, cover to the top with water", recipe:curry_chicken )
...
stir_fry_broccoli=Recipe.create(name: "Lightly Stir-fried Brocolli", owner: user1)
  ...
  Recipeingredient.create(amount:"1 tbsp", recipe:stir_fry_broccoli, ingredient:canola_oil)
...
grilled_cheese = Recipe.create(name: "Grilled Cheese", owner: user1)
 Recipeingredient.create(amount:"1 slice", ingredient:cheddar, recipe:grilled_cheese )
 Recipeingredient.create(amount:"1 slice", ingredient:provolone, recipe:grilled_cheese )
 Recipeingredient.create(amount:"2 slices", ingredient:bread, recipe:grilled_cheese )
 Recipeingredient.create(amount:"1 tbsp", ingredient:butter, recipe:grilled_cheese )
...
crepes = Recipe.create(name: "Quick Crepes", owner: user1)
  ...
  Instruction.create(step:"Melt butter and combine all ingredients into a blender with 1/2 cup water", recipe:crepes)
...
custard = Recipe.create(name: "Simple Custard", owner: user1)
  ...
  Instruction.create(step:"Combine milk, cornstarch, and sugar in a pot over medium heat", recipe:custard)
  Instruction.create(step:"When bubbles start forming use some of the mixutre to temper the eggs", recipe:custard)
